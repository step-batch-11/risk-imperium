...
This skill is the **entry point and conductor** for implementing a GitHub issue
end-to-end. It owns the overall flow and phase gates. Detailed instructions for
planning and task creation live in separate sub-skills — **load each sub-skill
only when you reach that phase**.
